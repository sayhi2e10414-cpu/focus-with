...
OAUTH_COPY = {
    "en": {
        ...
        "note": "The password is checked by your own server. The connected client receives a revocable token, never your password.",
        "switch": "简体中文",
    ...
    "zh-CN": {
        ...
        "password": "管理密码",
        "submit": "安全连接",
        "note": "密码只由你自己的服务器校验。连接的 AI 客户端获得的是可撤销 Token，永远不会收到你的密码。",
        "switch": "English",
